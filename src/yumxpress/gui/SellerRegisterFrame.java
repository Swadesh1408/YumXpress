...
public class SellerRegisterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sec_key = new javax.swing.JTextField();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/seller register.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 60)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Seller Registration");
        ...
        comp_name.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        ...
        sec_key.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N

        owner_name.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        ...
        Register.setBackground(new java.awt.Color(153, 102, 255));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(comp_name, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(42, 42, 42)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(owner_name, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(46, 46, 46)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                ...
                .addGap(52, 52, 52)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(sec_key, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addGap(73, 73, 73)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
         ...
         try{
             ...
             comp.setComp_name(comp_name.getText().trim());
             comp.setOwner_name(owner_name.getText().trim());
             comp.setEmailId(email.getText().trim());
             comp.setSec_key(sec_key.getText().trim());
             char []pwd=this.pass.getPassword();
             ...
             JOptionPane.showMessageDialog(null,"DB Error is SellerRegistrationFrame");
             ex.printStackTrace();
         }
    ...
    private javax.swing.JTextField sec_key;
    // End of variables declaration//GEN-END:variables

    private boolean validateInputs() {
        char []pwd=this.pass.getPassword();
        if(pwd.length==0||this.comp_name.getText().trim().isEmpty()||this.owner_name.getText().trim().isEmpty()||this.sec_key.getText().trim().isEmpty()||this.email.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(null,"Please fill all the details");
            return false;
        }
        if(Validator.isValidEmail(this.email.getText().trim())==false){
